                ...
                <tr >
                    ...
                    <td >
                            <form action="schedule.php" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Lawyer name or Email or Date (YYYY-MM-DD)" list="lawyers" >&nbsp;&nbsp;
                                            ...
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            Lawyer name:  &nbsp;&nbsp;<b>'.$lawyername.'</b><br>
                                                            Lawyer Email:  &nbsp;&nbsp;<b>'.$lawyeremail.'</b> 
                                                        </div>
