...
<head>
    ...
    <title>Scheduled Sessions | SafeSpace PH</title>
    <style>
        .popup{
 ...
 <div class="container">
     ...
     <table class="menu-container" border="0">
             ...
             <tr class="menu-row" >
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session menu-active menu-icon-session-active">
                        <a href="schedule.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text menu-text-active">Scheduled Sessions</p></div></a>
                    </td>
                </tr>
        ...
        <?php
                ...
                $sqlmain= "select * from schedule inner join lawyer on schedule.lawyerid=lawyer.lawyerid where schedule.scheduledate>='$today'  order by schedule.scheduledate asc";
                $sqlpt1="";
                $insertkey="";
                $q='';
                $searchtype="All";
                ...
                <tr >
                    ...
                    <td >
                            <form action="" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Lawyer name or Email or Date (YYYY-MM-DD)" list="lawyers" value="<?php  echo $insertkey ?>">&nbsp;&nbsp;
                                        
                                        <?php
                                            echo '<datalist id="lawyers">';
                                            $list11 = $database->query("select DISTINCT * from  lawyer;");
