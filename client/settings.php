...
// Safety check to prevent errors if user data is not found
if ($userfetch) {
    $userid = $userfetch["cid"];
    $username = $userfetch["cname"];
} else {
    // If user data can't be fetched, it's a critical session error.
    // Destroy the session and redirect to login to prevent further errors.
    session_destroy();
    header("location: ../login.php");
    exit();
}
            ...
            <tr class="menu-row">
                <td class="menu-btn menu-icon-report">
                    <a href="report.php" class="non-style-link-menu">
                        <div><p class="menu-text">Report Violation</p></div>
                    </a>
                </td>
            </tr>
            <tr class="menu-row">
                <td class="menu-btn menu-icon-schedule">
                    <a href="request-session.php" class="non-style-link-menu">
                        <div><p class="menu-text">Find a Safe Space</p></div>
                    </a>
                </td>
            </tr>
            <tr class="menu-row">
                <td class="menu-btn menu-icon-session">
                    <a href="client-appointment.php" class="non-style-link-menu">
            ...
            <tr class="menu-row">
                <td class="menu-btn menu-icon-settings menu-active menu-icon-settings-active">
                    <a href="settings.php" class="non-style-link-menu non-style-link-menu-active">
                        <div><p class="menu-text menu-text-active">Settings</p></a></div>
                </td>
            </tr>
        </table>
    </div>
                ...
                <td colspan="4">
                    <center>
                        <table class="filter-container" style="border: none;" border="0">
                                ...
                                <td style="width: 25%;">
                                    <a href="?action=edit&id=<?php echo $userid ?>&error=0" class="non-style-link">
                                        <div class="dashboard-items setting-tabs"
                                            ...
                                            <div class="btn-icon-settings dashboard-icons-setting"
                                                 style="background-image: url('../img/icons/account-settings-icon.svg');"></div>
                                            <div>
                                ...
                                <td style="width: 25%;">
                                    <a href="?action=view&id=<?php echo $userid ?>" class="non-style-link">
                                        <div class="dashboard-items setting-tabs"
                                             style="padding:20px;margin:auto;width:95%;display: flex;">
                                            <div class="btn-icon-settings dashboard-icons-setting "
                                                 style="background-image: url('../img/icons/view-icon.svg');"></div>
                                            <div>
                                                <div class="h1-dashboard">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <a href="?action=drop&id=<?php echo $userid . '&name=' . urlencode($username) ?>"
                                       class="non-style-link">
                                        <div class="dashboard-items setting-tabs"
                                             style="padding:20px;margin:auto;width:95%;display: flex;">
                                            <div class="btn-icon-settings dashboard-icons-setting"
                                                 style="background-image: url('../img/icons/delete-icon.svg');"></div>
                                            <div>
        ...
        <div id="popup1" class="overlay active">
            <div class="modal-content">
                ...
                <div class="modal-footer" style="justify-content: center;">
                    ...
                    <a href="delete-account.php?id=' . $id . '" class="modal-btn modal-btn-danger">Delete</a>
                </div>
            </div>
        </div>';
    } elseif ($action == 'view') {
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="detail-grid">
                        ...
                        <div class="detail-item"><strong>Date of Birth:</strong> <span>' . htmlspecialchars($dob) . '</span></div>
        ...
        if ($error_1 != '4') {
            ...
            <div id="popup1" class="overlay active">
                <div class="modal-content">
                    ...
                    <div class="modal-divider"></div>
                    <div class="modal-body">
                        <form action="edit-clients.php" method="POST">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="input-text" placeholder="Full Name" value="' . htmlspecialchars($name) . '" readonly>
                                </div>
                                <div class="form-group">
