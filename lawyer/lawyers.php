            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-lawyers menu-active menu-icon-lawyers-active">
                        <a href="lawyers.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Lawyers</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="lawyerbarid" class="input-text" placeholder="Bar ID Number" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
