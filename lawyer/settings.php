    ...
    <tr class="menu-row">
        <td class="menu-btn menu-icon-settings  menu-active menu-icon-settings-active">
            <a href="settings.php" class="non-style-link-menu non-style-link-menu-active">
                <div>
                    <p class="menu-text menu-text-active">Settings</p>
            </a></div>
        </td>
    </tr>
                                    ...
                                    <a href="?action=edit&id=<?php echo $userid ?>&error=0" class="non-style-link">
                                        <div class="dashboard-items setting-tabs"
                                            ...
                                            <div class="btn-icon-settings dashboard-icons-setting"
                                                style="background-image: url('../img/icons/account-settings-icon.svg'); background-size: 30px 30px; display: flex; align-items: center; justify-content: center;">
                                            </div>
                                            <div>
